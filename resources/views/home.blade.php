...
<script>
    ...
    function load(files) {
        ...
        form.onsubmit = (e) => {
            ...
            switch (idbutton) {
                case "1":
                    url = 'https://apitools.t4tek.tk/api/word-to-pdf'
                    break;
                case "2":
                    url = 'https://apitools.t4tek.tk/api/word-to-pdf' //tạm thời ch có
                    break;
                case "3":
                    url = 'https://apitools.t4tek.tk/api/pdf-to-txt' //txt
                    break;
                case "4":
                    url = 'https://apitools.t4tek.tk/api/txt-to-json'
                    break;
                default:
                    location.reload();
                    break;
